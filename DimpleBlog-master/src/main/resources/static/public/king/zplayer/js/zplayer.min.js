...
zplayer.prototype.init = function() {
	...
	if(!this.option.fixed){
		ht+= this.option.showLrc ? '<div class="zlrc"  style="z-index:12;">' : '<div class="zlrc" style="display:none">'; 
	...
	ht+= '			<div class="zplayer-controller">'
		...
		ht += this.option.lrcStart ? (this.option.showLrc ? '<i class="lrc-icon z-icon z-icon-list-alt" title="歌词"></i>' : '<i class="lrc-icon z-icon z-icon-list-alt lrc-hide" title="歌词"></i>') : '';
		ht +='					</div>'
			+'				</div>'
			+'			</div>'
			+'		</div>'
